               ...
               {value=>{
                   ...
                   return (
                    <div className="container py-5">
                        ...
                        <div className="row">
                            <div className="product-detial col-10 mx-auto col-md-6 my-3">
                            ...
                            <div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
                                ...
                                <div>
                                    <Link to="/">
                                        <button type="button" className="btn btn-outline-secondary"> Back to products</button>
                                    </Link>
                                    <button type="button" className="btn btn-outline-primary" Cart disabled={inCart?true:false} onClick={()=>{ value.addToCart(id); value.openModal(id);}}>
